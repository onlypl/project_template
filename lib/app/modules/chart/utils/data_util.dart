...
class DataUtil {
  ...
  ///计算MA
  static calcMA(List<KLineModel> dataList, List<int> maDayList) {
  ...
  ///计算BOLL
  static void calcBOLL(List<KLineModel> dataList, int n, int k) {
  ...
  ///计算BOLL的MA
  static void _calcBOLLMA(int day, List<KLineModel> dataList) {
    double ma = 0;
    for (int i = 0; i < dataList.length; i++) {
      KLineModel entity = dataList[i];
      ma += entity.close;
  ...
  ///计算MACD
  static void calcMACD(List<KLineModel> dataList) {
    double ema12 = 0;
    double ema26 = 0;
    double dif = 0;
    double dea = 0;
  ...
  ///计算VOLUME MA
  static void calcVolumeMA(List<KLineModel> dataList) {
    double volumeMa5 = 0;
    double volumeMa10 = 0;
  ...
  ///计算RSI
  static void calcRSI(List<KLineModel> dataList) {
    double? rsi;
    double rsiABSEma = 0;
    double rsiMaxEma = 0;
    for (int i = 0; i < dataList.length; i++) {
  ...
  ///计算KDJ
  static void calcKDJ(List<KLineModel> dataList) {
    var preK = 50.0;
    var preD = 50.0;
  ...
  ///计算WR
  static void calcWR(List<KLineModel> dataList) {
    double r;
    for (int i = 0; i < dataList.length; i++) {
      KLineModel entity = dataList[i];
      int startIndex = i - 14;
  ...
  ///计算CCI
  static void calcCCI(List<KLineModel> dataList) {
