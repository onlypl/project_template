...
class ProgressHUD {
  ...
  static showLoadingText(String loadingText) {
...
CancelFunc _showLoading(loadingText) {
  return BotToast.showCustomLoading(
    ...
    backgroundColor: Colors.transparent,
    toastBuilder:
        (cancelFunc) => _showCustomToast(loadingText, _ToastType.loading),
  );
}
    ...
    child: ClipRect(
      child: Column(
        ...
        children: <Widget>[
          ...
          toastType == _ToastType.loading
              ? (loadingText.trim().isNotEmpty
                  ? Text(
                    loadingText,
