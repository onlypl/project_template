...
///评论输入控件
class SendMsgInput extends StatefulWidget {
  final ValueChanged<String>? onChanged;
  final ValueChanged<String>? onSubmitted;
  final String? text;
  const SendMsgInput({super.key, this.onChanged, this.onSubmitted, this.text});

  @override
  State<SendMsgInput> createState() => _CommentInputState();
}

class _CommentInputState extends State<SendMsgInput> {
