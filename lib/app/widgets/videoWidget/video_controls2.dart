...
///保留原始版本
class VideoControls2 extends StatefulWidget {
  const VideoControls2({
  ...
  State<StatefulWidget> createState() {
    return _VideoControls2State();
  }
}

class _VideoControls2State extends State<VideoControls2>
  ...
  // GestureDetector _buildExpandButton2() {
  //   return GestureDetector(
